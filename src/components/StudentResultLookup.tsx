...
export default function StudentResultLookup(): JSX.Element {
  ...
  const token: string =
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..Kr9cW-DNx1tS1BeUKCM8bUUXMcav1KRXx4LJoCdAoZo";
                ...
                <Space direction="vertical" style={{ width: "100%" }}>
                  ...
                  <Select
                    ...
                    options={[
                      ...
                      { value: "118", label: <span>Agile Scrum</span>}
                    ]}
                  />
                </Space>
              </Col>
